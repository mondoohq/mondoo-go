...
// TailscaleConfigurationOptionsInput represents tailscale integration input.
type TailscaleConfigurationOptionsInput struct {
	// Tailscale API access token. (Required.)
	Token String `json:"token" tfgen:"required=1"`
}
