...
type CreatePlanInput struct {
	...
	ScopeMrn String `json:"scopeMrn" tfgen:"required=1"`
	// The assets to plan over. Already chosen by the caller — this slice selects nothing and filters nothing. (Required.)
	AssetMrns []String `json:"assetMrns" tfgen:"required=1"`
