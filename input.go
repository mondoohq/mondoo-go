...
type CaseTicketConfigInput struct {
	...
	// Webhook ticket configuration. (Optional.)
	Webhook *WebhookTicketConfigInput `json:"webhook,omitempty" tfgen:"required=0"`
}
...
// WebhookTicketConfigInput represents webhook ticket configuration input.
type WebhookTicketConfigInput struct {
	// Url to be called. (Required.)
	Url String `json:"url" tfgen:"required=1"`
}
