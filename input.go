...
// ExceptionGroupsOrder represents exception groups order.
type ExceptionGroupsOrder struct {
	// Direction. (Required.)
	Direction OrderDirection `json:"direction"`
	// Field. (Required.)
	Field ExceptionGroupsOrderField `json:"field"`
}
...
type ListExceptionGroupsInput struct {
	...
	OrderBy *ExceptionGroupsOrder `json:"orderBy,omitempty"`
}
