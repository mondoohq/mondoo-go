...
type ApplyIntuneRemediationInput struct {
	...
	// The Intune device group ID to target. (Required.)
...
// SetGithubRepoScanConfigInput represents input for setGithubRepoScanConfig: identifies a repo tracked under a GitHub integration and the scan-config fields to change. Omitted fields are left unchanged.
type SetGithubRepoScanConfigInput struct {
	// The mrn of the GitHub integration the repository belongs to. (Required.)
	IntegrationMrn String `json:"integrationMrn" tfgen:"required=1"`
	// GitHub's numeric repository id identifying the repo entry (as returned by githubIntegrationRepos). (Required.)
	GithubRepoId String `json:"githubRepoId" tfgen:"required=1"`
