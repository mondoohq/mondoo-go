...
type AuditLogExportConfigurationOptionsInput struct {
	...
	// Export interval in minutes (minimum 15, default 60). (Optional.)
	IntervalMinutes *Int `json:"intervalMinutes,omitempty" tfgen:"required=0"`
