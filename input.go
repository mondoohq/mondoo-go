...
// MvdOrder represents mVD order.
type MvdOrder struct {
	// Order direction. (Required.)
	Direction OrderDirection `json:"direction"`
	// Order field. (Required.)
	Field MvdOrderField `json:"field"`
}
